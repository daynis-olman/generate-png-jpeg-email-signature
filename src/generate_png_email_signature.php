...
$png_image = imagecreatefrompng('../images/baseline_image.png');
...
// Print Name on Image
imagettftext($png_image, 15, 0, 202, 40, $black, $font_path, $fullname);

// Print JobTitle on Image
imagettftext($png_image, 11, 0, 202, 62, $black, $font_path, $jobtitle);

// Print Organisation + Department name on Image
imagettftext($png_image, 11, 0, 202, 84, $black, $font_path, $organisation);

// Print Office phone + Mobile phone on Image
imagettftext($png_image, 10, 0, 227, 153, $black, $font_path, $phonenumbers);

// Print Office phone + Mobile phone on Image
imagettftext($png_image, 10, 0, 227, 175, $black, $font_path, $email);

// Print Company Website on Image
imagettftext($png_image, 10, 0, 227, 199, $black, $font_path, $website);

// Save image in temporary directory
$signatureFilename = "nwl-email-signature.png";
imagepng($png_image, "../tmp/" . $signatureFilename);
...
$zip = new ZipArchive;
$tmp_file = "../tmp/email-signature-png.zip";
